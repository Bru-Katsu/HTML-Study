$(document).ready(function(){
  new Vivus('graphic-svg', {type: 'sync',duration: 100});
  new Vivus('student-svg', {type: 'delayed',duration: 100});
  new Vivus('dev-svg', {type: 'delayed',duration: 100});
  new Vivus('ux-svg', {type: 'delayed',duration: 100});
